<template>
	<view class="uni-file-picker">
		<view v-if="title" class="uni-file-picker__header">
			<text class="file-title" :class="[$store.state.zlbslhfont?'font-size-scale15':'font-size-scale1']">{{ title }}</text>
			<text class="file-count" :class="[$store.state.zlbslhfont?'font-size-scale15':'font-size-scale1']">{{ filesList.length }}/{{ limitLength }}</text>
		</view>
		<upload-image
